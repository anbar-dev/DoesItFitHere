...
function Save-ProfileImage($Path) {
  ...
  $Olive = New-Brush "#244c49"
  $Cream = New-Brush "#fbfaf6"
  $Terracotta = New-Brush "#c85f46"
  $Ink = New-Brush "#20231f"
  $Muted = New-Brush "#62685f"
  $Gold = New-Brush "#e4aa3f"
  ...
  Draw-CenteredText $Graphics "FIMS" $BigFont $Ink (New-Object System.Drawing.RectangleF(100, 210, 600, 230))
  Draw-CenteredText $Graphics "FITS IN" $SmallFont $Terracotta (New-Object System.Drawing.RectangleF(100, 455, 600, 55))
  Draw-CenteredText $Graphics "MY SPACE" $TinyFont $Muted (New-Object System.Drawing.RectangleF(100, 510, 600, 48))
...
function Save-FaviconPng($Path, $Size) {
  ...
  Draw-CenteredText $Graphics "F" $Font $Terracotta (New-Object System.Drawing.RectangleF(0, -($Size * 0.03), $Size, $Size))
